...
var MastraScorer = class _MastraScorer {
  ...
  toMastraWorkflow() {
    const workflowSteps = this.steps.map((scorerStep) => {
      return chunk253FBVD4_cjs.createStep({
        id: scorerStep.name,
    ...
    const workflow = chunk253FBVD4_cjs.createWorkflow({
  ...
  async executePromptStep(scorerStep, tracingContext, context) {
    ...
    const judge = new chunk253FBVD4_cjs.Agent({
      name: "judge",
      model: resolvedModel,
      instructions,
    ...
    if (scorerStep.name === "generateScore") {
      ...
      if (resolvedModel.specificationVersion === "v2") {
        result = await chunk253FBVD4_cjs.tryGenerateWithJsonFallback(judge, prompt, {
          structuredOutput: {
            schema
          },
          tracingContext
...
function isWorkflow(target) {
  return target instanceof chunk253FBVD4_cjs.Workflow;
}
...
//# sourceMappingURL=chunk-ROS5CMJS.cjs.map
//# sourceMappingURL=chunk-ROS5CMJS.cjs.map