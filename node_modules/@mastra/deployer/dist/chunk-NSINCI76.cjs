...
async function getInputOptions(entryFile, analyzedBundleInfo, platform, env = { "process.env.NODE_ENV": JSON.stringify("production") }, {
  ...
  const normalizedEntryFile = chunkIAEJ3C3J_cjs.slash(entryFile);
  return {
    ...
    plugins: [
      ...
      alias__default.default({
        entries: [
          {
            find: /^\#server$/,
            replacement: chunkIAEJ3C3J_cjs.slash(url.fileURLToPath(undefined("@mastra/deployer/server")))
          },
          {
            find: /^\@mastra\/server\/(.*)/,
      ...
      chunkIAEJ3C3J_cjs.removeDeployer(entryFile, { sourcemap }),
...
//# sourceMappingURL=chunk-NSINCI76.cjs.map
//# sourceMappingURL=chunk-NSINCI76.cjs.map