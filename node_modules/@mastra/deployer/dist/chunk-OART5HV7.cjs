...
var Bundler = class extends bundler.MastraBundler {
  ...
  createBundler(inputOptions, outputOptions) {
    return chunkNSINCI76_cjs.createBundler(inputOptions, outputOptions);
  }
  async analyze(entry, mastraFile, outputDirectory, { enableEsmShim = true } = {}) {
    return await chunkIAEJ3C3J_cjs.analyzeBundle(
      [].concat(entry),
      mastraFile,
      {
  ...
  async getBundlerOptions(serverFile, mastraEntryFile, analyzedBundleInfo, toolsPaths, { enableSourcemap = false, enableEsmShim = true } = {}) {
    const { workspaceRoot } = await chunkIAEJ3C3J_cjs.getWorkspaceInformation({ mastraEntryFile });
  ...
  async _bundle(serverFile, mastraEntryFile, {
    ...
    let sourcemap = false;
    try {
      const bundlerOptions = await chunkIAEJ3C3J_cjs.getBundlerOptions(mastraEntryFile, analyzeDir);
    ...
    try {
      ...
      analyzedBundleInfo = await chunkIAEJ3C3J_cjs.analyzeBundle(
    ...
    for (const dep of analyzedBundleInfo.externalDependencies) {
      try {
        ...
        const rootPath = await chunkIAEJ3C3J_cjs.getPackageRootPath(dep);
...
//# sourceMappingURL=chunk-OART5HV7.cjs.map
//# sourceMappingURL=chunk-OART5HV7.cjs.map